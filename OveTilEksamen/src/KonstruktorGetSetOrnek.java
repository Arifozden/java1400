 class Konto {//Class burada
     private String personnummer;  //ozellikler burada
     private String navn;
     private double saldo;

     public Konto(String personnummer, String navn, double saldo) {  //konsturktor burada
...
public class KonstruktorGetSetOrnek {
